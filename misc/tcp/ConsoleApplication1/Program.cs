...
namespace ConsoleApplication1
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(" Remote Companion Program. \n Connect this computer to a shared WIFI network where DSes are also connected. \n Usage order: 1) Server Companion -- 2) NDS(s)  ");
            Console.WriteLine(" Remote Companion IP: [" + LocalIPAddress() + "] \n ");
            Console.WriteLine(" Protocol: DSWNIFI (1.4.1), developed by coto (2017-2022). Press ESC to quit ");
